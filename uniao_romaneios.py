...
df_iha = pd.read_csv(f'{caminho}/iha.csv', low_memory=False, sep=';',  encoding="ISO-8859-1", index_col=False)
...
df_iha.to_csv(f'C:/Users/Varad/Programming/Magalu/arcadeteste/romaneios/romaneios geral.csv', index=False)
